<?php
	...
	$imagePath = "/Users/paulovelho/Sites/paulovelho/dollar/images/";
	...
	$canvas->useFont('/Users/paulovelho/Sites/paulovelho/dollar/lib/Impact.ttf', 38, $image->allocateColor(0, 0, 0));
	...
	$canvas->useFont('/Users/paulovelho/Sites/paulovelho/dollar/lib/Impact.ttf', 38, $image->allocateColor(0, 0, 0));
	$canvas->writeText('center-'.$fontBorder, 'bottom-'.($fontMarginBottom+$fontBorder), $cent50);
	$canvas->useFont('/Users/paulovelho/Sites/paulovelho/dollar/lib/Impact.ttf', 38, $image->allocateColor(255, 255, 255));
